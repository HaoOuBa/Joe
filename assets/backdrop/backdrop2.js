(function (t, i) {
    'object' == typeof window && (window[t] = i());
})('Ribbons', function () {
    var t = window,
        i = document.body,
    ...
    var e = function (t) {
        (this._canvas = null), (this._context = null), (this._sto = null), (this._width = 0), (this._height = 0), (this._scroll = 0), (this._ribbons = []), (this._options = { colorSaturation: '80%', colorBrightness: '60%', colorAlpha: 0.65, colorCycleSpeed: 6, verticalPosition: 'center', horizontalSpeed: 200, ribbonCount: 3, strokeSize: 0, parallaxAmount: -0.5, animateSections: !0 }), (this._onDraw = this._onDraw.bind(this)), (this._onResize = this._onResize.bind(this)), (this._onScroll = this._onScroll.bind(this)), this.setOptions(t), this.init();
    };
    return (
        (e.prototype = {
            constructor: e,
            ...
            init: function () {
                try {
                    (this._canvas = document.createElement('canvas')), (this._canvas.style.position = 'fixed'), (this._canvas.style.left = '0'), (this._canvas.style.top = '0'), (this._canvas.style.right = '0'), (this._canvas.style.bottom = '0'), (this._canvas.style['z-index'] = '-1000'), (this._canvas.style['pointer-events'] = 'none'), (this._canvas.style['background-color'] = '#f5f5f5'), (this._canvas.id = 'bgCanvas'), this._onResize(), (this._context = this._canvas.getContext('2d')), this._context.clearRect(0, 0, this._width, this._height), (this._context.globalAlpha = this._options.colorAlpha), window.addEventListener('resize', this._onResize), window.addEventListener('scroll', this._onScroll), document.body.appendChild(this._canvas);
                } catch (t) {
            ...
            addRibbon: function () {
                ...
                for (var _ = [], p = new h(l, c), d = new h(l, c), u = null, f = Math.round(o(0, 360)), b = 0; !(i <= 0); ) {
                    if ((i--, (a = Math.round((1 * Math.random() - 0.2) * this._options.horizontalSpeed)), (r = Math.round((1 * Math.random() - 0.5) * (0.25 * this._height))), (u = new h()), u.copy(d), 'right' === t)) {
                        if ((u.add(a, r), d.x >= e)) break;
                    } else if ('left' === t && (u.subtract(a, r), d.x <= s)) break;
                    _.push({ point1: new h(p.x, p.y), point2: new h(d.x, d.y), point3: u, color: f, delay: b, dir: t, alpha: 0, phase: 0 }), p.copy(d), d.copy(u), (b += 4), (f += this._options.colorCycleSpeed);
                }
            ...
            _drawRibbonSection: function (t) {
                if (t) {
                    ...
                    if (t.delay <= 0) {
                        if (((t.phase += 0.02), (t.alpha = 1 * Math.sin(t.phase)), (t.alpha = t.alpha <= 0 ? 0 : t.alpha), (t.alpha = t.alpha >= 1 ? 1 : t.alpha), this._options.animateSections)) {
