...
?>
        ...
        <link rel="stylesheet" href="<?php Helper::options()->themeUrl('typecho/write/css/joe.write.min.css?v=202104191518') ?>">
        <script>
            window.JoeConfig = {
        ...
        <script src="<?php Helper::options()->themeUrl('assets/js/joe.short.min.js?v=202104191518') ?>"></script>
<?php
    }
}
